    ...
    while exitTrial == false
        ...
        elseif trialState  == 3   && triggerSent==1 && vbl - emgStartTime > Trigger_time - emgStartTime + 1
            ...
            if TMS_State_selector(ii)==2
                ...
                save([subDir filesep 'sub-' num2str(subNum) '-down-' SesNum '-' blockNumber_str '-TMStime-' TMS_time '-eeg-mep' (num2str(ii)) '.mat'], 'feedbackData');
            ...
            elseif TMS_State_selector(ii)==1
                save([subDir filesep 'sub-' num2str(subNum) '-down-' SesNum '-' blockNumber_str '-eeg-mep' (num2str(ii)) '.mat'], 'feedbackData');
...
save([subDir filesep 'sub-' num2str(subNum) '-down-' SesNum '-' blockNumber_str '-success-' (num2str(nSuccess)) '-eeg.mat'], 'nSuccess', 'percentage_success');
...
file_ID = fopen([subDir filesep 'sub-' num2str(subNum) '-down-' SesNum '-' blockNumber_str '-profile-eeg.txt'], 'a');
