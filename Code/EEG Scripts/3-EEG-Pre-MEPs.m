...
% end
    ...
    subDir = [direc filesep subCode filesep 'sess' num2str(SesNum) filesep 'pre-mep'];
    if ~exist(subDir,'dir')
        mkdir(subDir);
    end
...
dataFilename = [subDir filesep 'pre-' 'm' num2str(nMEPs) '-eeg.dat'];
...
for ii = 1:nMEPs
    ...
    save([subDir filesep 'pre-' 'mep' (num2str(ii)) '-eeg.mat'], 'feedbackData');
...
file_ID = fopen([subDir filesep 'Profile-pre-eeg.txt'], 'a');
