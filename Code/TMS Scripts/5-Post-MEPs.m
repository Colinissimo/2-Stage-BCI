...
dataFilename = [subDir filesep 'post-' 'm' num2str(nMEPs) '.dat'];
...
for ii = 1:nMEPs
    ...
    save([subDir filesep 'post-' 'mep' (num2str(ii)) '.mat'], 'feedbackData');
...
file_ID = fopen([subDir filesep 'Profile-post.txt'], 'a');
