...
dataFilename = [subDir filesep 'pre-' 'm' num2str(nMEPs) '.dat'];
...
for ii = 1:nMEPs
    ...
    save([subDir filesep 'pre-' 'mep' (num2str(ii)) '.mat'], 'feedbackData');
...
file_ID = fopen([subDir filesep 'Profile-pre.txt'], 'a');
